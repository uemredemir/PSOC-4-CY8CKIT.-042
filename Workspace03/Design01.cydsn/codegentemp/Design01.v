...
module top ;
	...
	wire [7:0] tmpOE__Ledler_net;
	wire [7:0] tmpFB_7__Ledler_net;
	wire [7:0] tmpIO_7__Ledler_net;
	wire [0:0] tmpINTERRUPT_0__Ledler_net;
	electrical [0:0] tmpSIOVREF__Ledler_net;
	...
	cy_psoc3_pins_v1_10
		...
		Ledler
		 (.oe(tmpOE__Ledler_net),
		  .y({8'b0}),
		  .fb({tmpFB_7__Ledler_net[7:0]}),
		  .io({tmpIO_7__Ledler_net[7:0]}),
		  .siovref(tmpSIOVREF__Ledler_net),
		  .interrupt({tmpINTERRUPT_0__Ledler_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Ledler_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{8'b11111111} : {8'b11111111};
